        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('pattern') && value !== '') {
                ...
                if (!pattern.test(value)) {
                    showError(input, input.getAttribute('data-error') || 'Invalid format');
                    return false;
                }
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = submitButton.getAttribute('data-loading') || 'Sending...';
                }
                ...
                setTimeout(function() {
                    ...
                    if (submitButton) {
                        ...
                        submitButton.textContent = submitButton.getAttribute('data-original') || 'Send Message';
                    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '408da18d-6437-4cf5-bbb3-5d4483087c28',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '408da18d-6437-4cf5-bbb3-5d4483087c28';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '408da18d-6437-4cf5-bbb3-5d4483087c28';
